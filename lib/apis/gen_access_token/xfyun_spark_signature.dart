...
String genXfyunAssembleAuthUrl(
  ...
  // 准备API密钥和授权字符串
  String authorizationOrigin =
      'api_key=$apiKey, algorithm=hmac-sha256, headers=host date request-line, signature=$tmpSha';
  ...
  // 生成最终的WebSocket URL
  String url = '$hostUrl?${Uri(queryParameters: v)}';
  // 像上面加了问号变成2个了
  // String url = '$hostUrl?${Uri(queryParameters: v)}';
...
String genXfyunAssembleAuthUrl2(
