...
- 2024-08-04
  - feat: 新增“智能助手”的“你问我答”、“智能群聊”、“全网搜索”支持语音转文字输入的功能。
    - todo：保留和播放原音频。
    - 语音输入布局参考微信输入，[\_sounds_message_button](lib/views/ai_assistant/ai_tools/_sounds_message_button) 组件来源 [boomcx/sounds_message](https://github.com/boomcx/sounds_message)
- 2024-08-07
  - refactor: 简化和完善了文本对话需要的语音输入按钮组件。
  - feat: "你问我答"对话中语言输入时加入了语音文件，可点击播放。
- 2024-08-08
  - refactor: 简单重构了部分项目结构，添加了“你问我答”、“翻译助手”、“文档提要”的流式输出。
